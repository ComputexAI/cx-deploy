...
def df_main(input_directory, output_prefix, validate) -> None:
    ...
    print("MODEL PATH:", input_directory)
...
def hf_main(input_directory, output_prefix, validate):
    ...
    tokenizer = AutoTokenizer.from_pretrained(input_directory)
...
if __name__ == "__main__":
    main(
        ...
        input_directory="Salesforce/codet5p-16b",
        output_prefix="/mnt/codet5p16",
        validate=False
    )
