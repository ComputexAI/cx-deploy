...
def get_token(token_path="/secrets/user/.secrets.json"):
    ...
    {
    "app_name": "xgen-7b-8k-base",
    "container_image": "registry.computex.ai/computex/predict-xgen-7b-8k-base:1",
    "model_image": "registry.computex.ai/computex/model-xgen-7b-8k-base:3",
    "num_cpu_cores": 10,
    "num_gpu": 1,
    "gpu_sku": "A40",
    "memory": 64,
...
def serialize_model(
    ...
    config: Optional[Union[AutoConfig, dict]],
    model_directory: str,
):
    """
...
def hf_main(input_directory, output_prefix):
    ...
    model_config = AutoConfig.from_pretrained(input_directory, trust_remote_code=True)
    ...
    tokenizer = AutoTokenizer.from_pretrained(input_directory, trust_remote_code=True)
    tokenizer.save_pretrained(output_prefix)
    logger.info("Done")


if __name__ == "__main__":
    hf_main(input_directory="Salesforce/xgen-7b-8k-base", output_prefix="/mnt/model")
